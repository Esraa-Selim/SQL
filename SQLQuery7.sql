...
Create procedure Student_Numbers
	as	
		select Dept_Name DepartmentName , count(St_Id) StudentNumber from Department D inner join Student S on s.Dept_Id = d.Dept_Id 
			group by Dept_Name
---2.	Create a stored procedure that will check for the # of employees in the project p1 if they are more than 3 print message to
---the user “'The number of employees in the project p1 is 3 or more'” if they are less display 
